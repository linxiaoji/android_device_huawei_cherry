...
# Kernel
BOARD_KERNEL_CMDLINE                        := hisi_dma_print=0 vmalloc=384M maxcpus=8 coherent_pool=512K no_irq_affinity androidboot.selinux=permissive ate_enable=true iommu_ddr_size=0x80000000 mem=1932M boardid=0x48696220,0x00000011,0x000002e9 productid=0x3d350500 pmu_nv_addr=0x070c49b0 low_volt_flag=0 iommu_enable boottype=pknormal enter_recovery=0 androidboot.swtype=normal fastboot_version=DailyBuild_201601241151_FASTBOOT androidboot.serialno=A8K4C15820001092 rescue_version=  otg.status=enable normal_reset_type=press1s himntn=00011100000000000000000000001000 LCD_TYPE=TM_NT35521_LCD density=320 setup_logctl=0 loglevel=5 bitmapofabnrst=0x00000008  boot_slice=0x0001eff1 no_uart_console mdmlogbase=0x00000000 mdmlogsize=0x00000000 mdmlogtime=0x00000000 async_loadmodem efuse_status=0 recovery_update=0 fblock=unlocked androidboot.hardware=hi6210sft
